...
export default function Experience() {
  ...
  const defaultTimeline = [
    {
      ...
      company: "RAMA INTERNATIONAL",
      duration: "2025 – Present",
      location: "Commercial Delivery & Remote",
      status: "🟢 Current",
      description:
        "Designed and developed scalable recruitment and trading platforms using Django REST Framework, PostgreSQL and React. Focused on authentication, API optimization, deployment and production-ready architecture.",
      achievements: [
      ...
      tech: ["Python", "Django", "DRF", "React", "PostgreSQL", "JWT", "Docker", "Git"],
      icon: <FaServer className="text-2xl text-[#3B82F6]" />,
    },
    {
      ...
      status: "🟢 Current",
      description:
        "Built custom websites and backend systems for clients with responsive UI, secure APIs and deployment.",
      achievements: [
        "Engineered custom client web portals",
        "Designed secure RESTful API integrations",
        "Deployed production apps to Render & Vercel",
      ],
      tech: ["React", "Python", "Django", "REST API", "Tailwind CSS", "JavaScript", "PostgreSQL", "Git"],
    ...
    },
    {
      ...
      status: "🎓 In Progress",
      description:
        "Relevant Coursework: Data Structures, DBMS, Operating Systems, Python, Web Development.",
      achievements: [
        "Data Structures & Algorithms Mastery",
        "Relational Database Systems (SQL/DBMS)",
  ...
  const stats = t("experience.stats", { returnObjects: true }) || {
    ...
    focusValue: "Backend Engineering",
    expLabel: "Experience",
    expValue: "2+ Years",
  };
